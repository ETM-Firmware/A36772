    ...
    switch (global_data_A36772.control_state) {
        ...
        case STATE_WAIT_FOR_CONFIG:
            ...
            while (global_data_A36772.control_state == STATE_WAIT_FOR_CONFIG) {
                DoA36772();
                DoStartupLEDs();
                if (global_data_A36772.run_time_counter >= LED_STARTUP_FLASH_TIME) {
        ...
        case STATE_HEATER_RAMP_UP:
            global_data_A36772.watchdog_counter = 0;
            global_data_A36772.heater_set_point = 0;
            ETMAnalogOutputSetPoint(&global_data_A36772.analog_output_heater_voltage, global_data_A36772.heater_set_point);
            ETMAnalogInputInitializeRelativeTripLevels(&global_data_A36772.input_htr_v_mon,
                    global_data_A36772.heater_set_point,
            ...
            while (global_data_A36772.control_state == STATE_HEATER_RAMP_UP) {
                DoA36772();
                if (ETMAnalogOutputGetSetPoint(&global_data_A36772.analog_output_heater_voltage) >= global_data_A36772.heater_voltage_target) {
        ...
        case STATE_FAULT_HEATER_ON:
            ...
            ETMAnalogInputClearFaultCounters(&global_data_A36772.input_hv_v_mon);
            ETMAnalogInputClearFaultCounters(&global_data_A36772.input_top_v_mon);
        ...
        case STATE_FAULT_HEATER_OFF:
            ...
            ETMAnalogInputClearFaultCounters(&global_data_A36772.input_htr_v_mon);
            ETMAnalogInputClearFaultCounters(&global_data_A36772.input_htr_i_mon);
            ETMAnalogInputClearFaultCounters(&global_data_A36772.input_bias_v_mon);
...
void InitializeA36772(void) {
    ...
    ETMAnalogInputInitialize(&global_data_A36772.input_adc_temperature,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_TEMPERATURE_SENSOR_FIXED_SCALE),
            ADC_TEMPERATURE_SENSOR_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.input_hv_v_mon,
    ...
    ETMAnalogInputInitialize(&global_data_A36772.input_hv_i_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_HV_IMON_FIXED_SCALE),
            ADC_HV_IMON_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.input_gun_i_peak,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_GUN_I_PEAK_FIXED_SCALE),
            ADC_GUN_I_PEAK_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.input_htr_v_mon,
    ...
    ETMAnalogInputInitialize(&global_data_A36772.input_htr_i_mon,
            MACRO_DEC_TO_SCALE_FACTOR_16(ADC_HTR_I_MON_FIXED_SCALE),
            ADC_HTR_I_MON_FIXED_OFFSET,
            0);
    ETMAnalogInputInitializeFixedTripLevels(&global_data_A36772.input_htr_i_mon,
            ADC_HTR_I_MON_OVER_LIMIT_ABSOLUTE,
            ADC_HTR_I_MON_UNDER_LIMIT_ABSOLUTE,
            ADC_HTR_I_MON_ABSOLUTE_TRIP_TIME);


    ETMAnalogInputInitialize(&global_data_A36772.input_top_v_mon,
    ...
    ETMAnalogInputInitialize(&global_data_A36772.pot_vtop,
            MACRO_DEC_TO_SCALE_FACTOR_16(POT_VTOP_FIXED_SCALE),
            POT_VTOP_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.pot_ek,
            MACRO_DEC_TO_SCALE_FACTOR_16(POT_EK_FIXED_SCALE),
            POT_EK_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.ref_htr,
            MACRO_DEC_TO_SCALE_FACTOR_16(REF_HTR_FIXED_SCALE),
            REF_HTR_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.ref_vtop,
            MACRO_DEC_TO_SCALE_FACTOR_16(REF_VTOP_FIXED_SCALE),
            REF_VTOP_FIXED_OFFSET,
            0);


    ETMAnalogInputInitialize(&global_data_A36772.ref_ek,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.analog_output_high_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.analog_output_top_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.analog_output_heater_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.monitor_heater_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.monitor_heater_current,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.monitor_cathode_voltage,
    ...
    ETMAnalogOutputInitialize(&global_data_A36772.monitor_grid_voltage,
...
void ResetAllFaultInfo(void) {
    ...
    global_data_A36772._FAULT_REGISTER = 0;
    global_data_A36772._WARNING_REGISTER = 0;
    ...
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_adc_temperature);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_hv_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_hv_i_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_gun_i_peak);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_htr_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_htr_i_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_top_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_bias_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_24_v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.input_dac_monitor);

    ETMAnalogInputClearFaultCounters(&global_data_A36772.pot_htr);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.pot_vtop);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.pot_ek);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.ref_htr);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.ref_vtop);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.ref_ek);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.pos_15v_mon);
    ETMAnalogInputClearFaultCounters(&global_data_A36772.neg_15v_mon);
...
void DoA36772(void) {
    ...
    if (ETMTickRunOnceEveryNMilliseconds(10, &timer_write_holding_var_10ms)) {
        ...
        if (global_data_A36772.watchdog_set_mode == WATCHDOG_MODE_0) {
            if ((ETMAnalogInputGetReading(&global_data_A36772.input_dac_monitor) > MIN_WD_VALUE_0) &&
                    (ETMAnalogInputGetReading(&global_data_A36772.input_dac_monitor) < MAX_WD_VALUE_0)) {
                global_data_A36772.watchdog_counter = 0;
            ...
            if ((ETMAnalogInputGetReading(&global_data_A36772.input_dac_monitor) > MIN_WD_VALUE_1) &&
                    (ETMAnalogInputGetReading(&global_data_A36772.input_dac_monitor) < MAX_WD_VALUE_1)) {
                global_data_A36772.watchdog_counter = 0;
                global_data_A36772.watchdog_state_change = 1;
        ...
        modbus_slave_hold_reg_0x22 = ETMAnalogInputGetReading(&global_data_A36772.input_htr_i_mon);
        modbus_slave_hold_reg_0x23 = ETMAnalogInputGetReading(&global_data_A36772.input_top_v_mon);
        modbus_slave_hold_reg_0x24 = ETMAnalogInputGetReading(&global_data_A36772.input_hv_v_mon);
        ...
        if (global_data_A36772.heater_ramp_interval >= HEATER_RAMP_UP_TIME_PERIOD) {
            ...
            if (ETMAnalogInputGetReading(&global_data_A36772.input_htr_i_mon) < MAX_HEATER_CURRENT_DURING_RAMP_UP) {
                global_data_A36772.heater_set_point += HEATER_RAMP_UP_INCREMENT;
                ETMAnalogOutputSetPoint(&global_data_A36772.analog_output_heater_voltage, global_data_A36772.heater_set_point);
                ETMAnalogInputInitializeRelativeTripLevels(&global_data_A36772.input_htr_v_mon,
                        global_data_A36772.heater_set_point,
                        ADC_HTR_V_MON_RELATIVE_TRIP_SCALE,
        ...
        if (ETMAnalogOutputGetSetPoint(&global_data_A36772.analog_output_heater_voltage) > global_data_A36772.heater_voltage_target) {
            ETMAnalogOutputSetPoint(&global_data_A36772.analog_output_heater_voltage, global_data_A36772.heater_voltage_target);
            ETMAnalogInputInitializeRelativeTripLevels(&global_data_A36772.input_htr_v_mon,
        ...
        if (global_data_A36772.control_state != STATE_WAIT_FOR_CONFIG) {
            switch ((global_data_A36772.run_time_counter & 0b111)) {
                ...
                case 0:
                    WriteLTC265X(&U32_LTC2654, LTC265X_WRITE_AND_UPDATE_DAC_A, ETMAnalogOutputGetDACValue(&global_data_A36772.monitor_heater_voltage));
                    DACWriteChannel(LTC265X_WRITE_AND_UPDATE_DAC_A, ETMAnalogOutputGetDACValue(&global_data_A36772.analog_output_high_voltage));
                    break;


                case 1:
                    WriteLTC265X(&U32_LTC2654, LTC265X_WRITE_AND_UPDATE_DAC_B, ETMAnalogOutputGetDACValue(&global_data_A36772.monitor_heater_current));
                    DACWriteChannel(LTC265X_WRITE_AND_UPDATE_DAC_B, ETMAnalogOutputGetDACValue(&global_data_A36772.analog_output_top_voltage));
                    break;


                case 2:
                    WriteLTC265X(&U32_LTC2654, LTC265X_WRITE_AND_UPDATE_DAC_C, ETMAnalogOutputGetDACValue(&global_data_A36772.monitor_cathode_voltage));
                    DACWriteChannel(LTC265X_WRITE_AND_UPDATE_DAC_C, ETMAnalogOutputGetDACValue(&global_data_A36772.analog_output_heater_voltage));
                    break;


                case 3:
                    WriteLTC265X(&U32_LTC2654, LTC265X_WRITE_AND_UPDATE_DAC_D, ETMAnalogOutputGetDACValue(&global_data_A36772.monitor_grid_voltage));
...
void UpdateFaults(void) {
    if (global_data_A36772.control_state < STATE_HEATER_RAMP_UP) {
        // Do not evaluate any more fault conditions
        return;
    }
    ...
    if (global_data_A36772.adc_read_ok) {
        ...
        if (ETMAnalogOutputGetSetPoint(&global_data_A36772.analog_output_heater_voltage) < 1500) {
            ETMAnalogInputClearFaultCounters(&global_data_A36772.input_htr_v_mon);
        }


        if (ETMAnalogInputFaultOverFixed(&global_data_A36772.input_htr_i_mon)) {
        ...
        if (global_data_A36772.control_state > STATE_HEATER_RAMP_UP) {
            if (ETMAnalogInputFaultUnderFixed(&global_data_A36772.input_htr_i_mon)) {
        ...
        if (ETMAnalogInputFaultOverRelative(&global_data_A36772.input_htr_v_mon)) {
            _FAULT_ADC_HTR_V_MON_OVER_RELATIVE = 1;
        } else if (global_data_A36772.reset_active) {
            _FAULT_ADC_HTR_V_MON_OVER_RELATIVE = 0;
        }

        if (ETMAnalogInputFaultUnderRelative(&global_data_A36772.input_htr_v_mon)) {
        ...
        if (global_data_A36772.control_state >= STATE_POWER_SUPPLY_RAMP_UP) {
            if (ETMAnalogInputFaultOverRelative(&global_data_A36772.input_hv_v_mon)) {
        ...
        if (global_data_A36772.control_state >= STATE_HV_ON) {
            if (ETMAnalogInputFaultUnderRelative(&global_data_A36772.input_hv_v_mon)) {
        ...
        if (global_data_A36772.control_state >= STATE_TOP_READY) {
            if (ETMAnalogInputFaultOverRelative(&global_data_A36772.input_top_v_mon)) {
        ...
        if (global_data_A36772.control_state >= STATE_TOP_READY) {
            if (ETMAnalogInputFaultUnderRelative(&global_data_A36772.input_top_v_mon)) {
        ...
        if (ETMAnalogInputFaultOverFixed(&global_data_A36772.input_bias_v_mon)) {
            _FAULT_ADC_BIAS_V_MON_OVER_ABSOLUTE = 1;
        } else if (global_data_A36772.reset_active) {
            _FAULT_ADC_BIAS_V_MON_OVER_ABSOLUTE = 0;
        }

        if (ETMAnalogInputFaultUnderFixed(&global_data_A36772.input_bias_v_mon)) {
...
void UpdateLEDandStatusOutuputs(void) {
    ...
    if (global_data_A36772._FAULT_REGISTER != 0) {
...
void SetStateMessage(unsigned int message) {
    ...
    if (global_data_A36772._WARNING_REGISTER) {
        message |= 0x0200;
    } else {
        message &= ~0x0200;
    }
...
void EnableHeater(void) {
     ...
     */
    ETMAnalogOutputEnable(&global_data_A36772.analog_output_heater_voltage);
...
void DisableHeater(void) {
     ...
     */
    ETMAnalogOutputDisable(&global_data_A36772.analog_output_heater_voltage);
...
void EnableHighVoltage(void) {
     ...
     */
    ETMAnalogOutputEnable(&global_data_A36772.analog_output_high_voltage);
...
void EnableTopSupply(void) {
    ...
    ETMAnalogOutputEnable(&global_data_A36772.analog_output_top_voltage);
...
void DisableHighVoltage(void) {
     ...
     */
    ETMAnalogOutputDisable(&global_data_A36772.analog_output_top_voltage);
    ETMAnalogOutputDisable(&global_data_A36772.analog_output_high_voltage);
...
void UpdateADCResults(void) {
    ...
    if (read_error) {
        ...
        ETMAnalogInputUpdate(&global_data_A36772.input_adc_temperature, read_data[0]);
        ETMAnalogInputUpdate(&global_data_A36772.input_hv_v_mon, (read_data[1] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_hv_i_mon, (read_data[2] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_gun_i_peak, (read_data[3] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_htr_v_mon, (read_data[4] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_htr_i_mon, (read_data[5] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_top_v_mon, (read_data[6] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_bias_v_mon, (read_data[7] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_24_v_mon, (read_data[8] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_temperature_mon, (read_data[9] << 4));
        ETMAnalogInputUpdate(&global_data_A36772.input_dac_monitor, (read_data[16] << 4));
...
void __attribute__((interrupt, no_auto_psv)) _ADCInterrupt(void) {
    ...
    if (_BUFS) {
        // read ADCBUF 0-7
        global_data_A36772.pot_ek_adc_accumulator += ADCBUF0;
        global_data_A36772.pot_vtop_adc_accumulator += ADCBUF1;
        global_data_A36772.pot_htr_adc_accumulator += ADCBUF2;
        global_data_A36772.ref_htr_adc_accumulator += ADCBUF3;
        global_data_A36772.ref_vtop_adc_accumulator += ADCBUF4;
        global_data_A36772.ref_ek_adc_accumulator += ADCBUF5;
        global_data_A36772.pos15v_adc_accumulator += ADCBUF6;
        global_data_A36772.neg15v_adc_accumulator += ADCBUF7;
    } else {
        // read ADCBUF 8-15
        global_data_A36772.pot_ek_adc_accumulator += ADCBUF8;
        global_data_A36772.pot_vtop_adc_accumulator += ADCBUF9;
        global_data_A36772.pot_htr_adc_accumulator += ADCBUFA;
        global_data_A36772.ref_htr_adc_accumulator += ADCBUFB;
        global_data_A36772.ref_vtop_adc_accumulator += ADCBUFC;
        global_data_A36772.ref_ek_adc_accumulator += ADCBUFD;
        global_data_A36772.pos15v_adc_accumulator += ADCBUFE;
        global_data_A36772.neg15v_adc_accumulator += ADCBUFF;
    }
    ...
    if (global_data_A36772.accumulator_counter >= 128) {
        ...
        global_data_A36772.pot_htr_adc_accumulator >>= 3;
        global_data_A36772.pot_vtop_adc_accumulator >>= 3;
        global_data_A36772.pot_ek_adc_accumulator >>= 3;
        global_data_A36772.ref_htr_adc_accumulator >>= 3;
        global_data_A36772.ref_vtop_adc_accumulator >>= 3;
        global_data_A36772.ref_ek_adc_accumulator >>= 3;
        global_data_A36772.pos15v_adc_accumulator >>= 3;
        global_data_A36772.neg15v_adc_accumulator >>= 3;

        // Store the filtered results
        ETMAnalogInputUpdate(&global_data_A36772.pot_htr, ((unsigned int) global_data_A36772.pot_htr_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.pot_vtop, ((unsigned int) global_data_A36772.pot_vtop_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.pot_ek, ((unsigned int) global_data_A36772.pot_ek_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.ref_htr, ((unsigned int) global_data_A36772.ref_htr_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.ref_vtop, ((unsigned int) global_data_A36772.ref_vtop_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.ref_ek, ((unsigned int) global_data_A36772.ref_ek_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.pos_15v_mon, ((unsigned int) global_data_A36772.pos15v_adc_accumulator));
        ETMAnalogInputUpdate(&global_data_A36772.neg_15v_mon, ((unsigned int) global_data_A36772.neg15v_adc_accumulator));

        // clear the accumulators
        global_data_A36772.pot_htr_adc_accumulator = 0;
        global_data_A36772.pot_vtop_adc_accumulator = 0;
        global_data_A36772.pot_ek_adc_accumulator = 0;
        global_data_A36772.ref_htr_adc_accumulator = 0;
        global_data_A36772.ref_vtop_adc_accumulator = 0;
        global_data_A36772.ref_ek_adc_accumulator = 0;
        global_data_A36772.pos15v_adc_accumulator = 0;
        global_data_A36772.neg15v_adc_accumulator = 0;
    }
}
...
void ETMModbusInit(void) {
    ...
    ETMEEPromReadPage(1, global_data_A36772.page_data1);
    ETMEEPromReadPage(2, global_data_A36772.page_data2);
    ETMEEPromReadPage(3, global_data_A36772.page_data3);
    ETMEEPromReadPage(4, global_data_A36772.page_data4);
    ETMEEPromReadPage(5, global_data_A36772.page_data5);
...
void ProcessCommand(MODBUS_MESSAGE * ptr) {
    ...
    switch (ptr->function_code) {
        ...
        case FUNCTION_WRITE_BIT:
            ...
            if ((ptr->write_value == 0x0000) || (ptr->write_value == 0xFF00)) {
                ...
                if ((coil_index >= 14) && (coil_index < 28)) {
                    global_data_A36772.page_data7[coil_index - 14] = ptr->write_value;
                    ETMEEPromWritePage(7, global_data_A36772.page_data7);
                }
                if ((coil_index >= 28) && (coil_index < 42)) {
                    global_data_A36772.page_data8[coil_index - 28] = ptr->write_value;
                    ETMEEPromWritePage(8, global_data_A36772.page_data8);
                }
                if ((coil_index >= 42) && (coil_index < 56)) {
                    global_data_A36772.page_data9[coil_index - 42] = ptr->write_value;
                    ETMEEPromWritePage(9, global_data_A36772.page_data9);
                }
                if ((coil_index >= 56) && (coil_index < 64)) {
                    global_data_A36772.page_data10[coil_index - 56] = ptr->write_value;
                    ETMEEPromWritePage(10, global_data_A36772.page_data10);
                }
            } else {
                ptr->received_function_code = ptr->function_code;
                ptr->function_code = EXCEPTION_FLAGGED;
        ...
        case FUNCTION_WRITE_REGISTER:
            ...
            if ((coil_index >= 14) && (coil_index < 28)) {
                global_data_A36772.page_data2[coil_index - 14] = ptr->write_value;
                ETMEEPromWritePage(2, global_data_A36772.page_data2);
            }
            if ((coil_index >= 28) && (coil_index < 42)) {
                global_data_A36772.page_data3[coil_index - 28] = ptr->write_value;
                ETMEEPromWritePage(3, global_data_A36772.page_data3);
            }
            if ((coil_index >= 42) && (coil_index < 56)) {
                global_data_A36772.page_data4[coil_index - 42] = ptr->write_value;
                ETMEEPromWritePage(4, global_data_A36772.page_data4);
            }
            if ((coil_index >= 56) && (coil_index < 64)) {
                global_data_A36772.page_data5[coil_index - 56] = ptr->write_value;
                ETMEEPromWritePage(5, global_data_A36772.page_data5);
            }
            break;
